...
require("../../service/swordapp-php-library-1.0/swordappservicedocument.php");
require("../../service/swordapp-php-library-1.0/swordappentry.php");
require("../../service/swordapp-php-library-1.0/swordapperrordocument.php");
require("../../service/swordapp-php-library-1.0/swordapplibraryversion.php");
