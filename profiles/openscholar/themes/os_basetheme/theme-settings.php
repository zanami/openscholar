...
/**
 * USAGE:
 * 1 - To use this file replace "os_basetheme" with the name of
...
// Replace 'os_basetheme' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function os_basetheme_form_system_theme_settings_alter(&$form, &$form_state)  {
